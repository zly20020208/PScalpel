...
% load('../model/net_ffnn_for_GAT_TTTGCL_rate005_p100_auc07117.mat');
load('../model/net_gammaVector_sG_local_and_global_double_oneplot_rate005_128_1L_p350.mat','net_gammaVector')
%% 加载图结构
...
save ../data/test_label.mat test_label
