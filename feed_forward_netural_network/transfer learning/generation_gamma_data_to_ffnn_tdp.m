...
load('../newdata/TDP/train_G_yes_20.mat');
load('../newdata/TDP/train_G_no_20.mat');
load('../newdata/TDP/test_G_20.mat');
...
%% 加载训练和测试数据
load('../newdata/TDP/train_data_yes.mat');
load('../newdata/TDP/train_data_no.mat');
load('../newdata/TDP/test_data.mat');
load('../newdata/TDP/test_label.mat');
...
save ../newdata/TDP/LLPS_data/train_data_yes.mat train_data_yes
save ../newdata/TDP/LLPS_data/train_data_no.mat train_data_no
save ../newdata/TDP/LLPS_data/test_data.mat test_data
save ../newdata/TDP/LLPS_data/test_label.mat test_label
