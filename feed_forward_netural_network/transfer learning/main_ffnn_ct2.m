...
%% 加载训练和测试数据
%% 加载训练和测试数据
load('../newdata/CGAS/LLPS_data/train_data_yes.mat');
load('../newdata/CGAS/LLPS_data/train_data_no.mat');
load('../newdata/CGAS/LLPS_data/test_data.mat');
load('../newdata/CGAS/LLPS_data/test_label.mat');

% load('muta_llps_data.mat')
% load('muta_llps_data_label.mat')

%% 加载lcs_features
load('../newdata/CGAS/train_lcs_features_yes.mat');
load('../newdata/CGAS/train_lcs_features_no.mat');
load('../newdata/CGAS/test_lcs_features.mat');
...
%         end
        ...
        save ../newdata/CGAS/net_ffnn_for_gamma_yuanshi.mat net_ffnn -v7.3
    end
end
