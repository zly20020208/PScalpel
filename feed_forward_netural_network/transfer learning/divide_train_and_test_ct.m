...
fprintf("保存测试数据...\n")
save newdata/CGAS/test_data.mat test_data -v7.3
save newdata/CGAS/test_label.mat test_label -v7.3
save newdata/CGAS/test_lcs_features.mat test_lcs_features -v7.3

fprintf("保存训练数据...\n")
save newdata/CGAS/train_data_yes.mat train_data_yes -v7.3
save newdata/CGAS/train_data_no.mat train_data_no -v7.3
save newdata/CGAS/train_lcs_features_yes.mat train_lcs_features_yes -v7.3
save newdata/CGAS/train_lcs_features_no.mat train_lcs_features_no -v7.3