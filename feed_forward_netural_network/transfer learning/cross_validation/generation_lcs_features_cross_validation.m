...
load('newdata/TDP43/TDP_mutations_no_seq.mat')
load('newdata/TDP43/TDP_mutations_yes_seq.mat')
addpath('method')
...
save newdata/TDP43/lcs_features_yes.mat lcs_features_yes -v7.3
save newdata/TDP43/lcs_features_no.mat lcs_features_no -v7.3
